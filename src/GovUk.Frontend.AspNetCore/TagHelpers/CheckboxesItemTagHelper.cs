...
namespace GovUk.Frontend.AspNetCore.TagHelpers
{
    ...
    [RestrictChildren(CheckboxesItemHintTagHelper.TagName, CheckboxesItemConditionalTagHelper.TagName)]
    ...
    public class CheckboxesItemTagHelper : TagHelper
    {
        ...
        public bool Checked { get; set; } = ComponentGenerator.CheckboxesItemDefaultChecked;
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (Name == null && checkboxesContext.Name == null)
            {
